...
describe('PokemonModel', () => {
    it('Sets the initial state and correct JSON return', () => {       
        ...
        expect(JSON.stringify(instance)).to.equal("{\"Name\":\"bulbasaur\",\"Id\":1,\"BaseExperience\":64,\"Height\":7,\"Weight\":69,\"Specie\":\"bulbasaur\",\"Abilities\":[\"overgrow\",\"chlorophyll\"],\"Forms\":[\"bulbasaur\"],\"Stats\":[[\"hp\",45]]}");
    })
